    ...
    <View style={{height : height, width : width, backgroundColor : 'white'}}>
            ...
            <View style={{backgroundColor : 'white', width : width, height : 70, flexDirection : 'row'}}>
                ...
                <View style={{ width : width-80, marginTop : 30}}>
                    <Text style={{color : 'gray', textAlign : 'center', fontSize : 18, marginTop : 5}}>Create Event</Text>
                </View>
            </View>
            ...
            <Content>
                ...
                <View style={{flexDirection : 'row',width : width, paddingLeft : 10, marginTop : 30}}>
                    ...
                    <TextInput underlineColorAndroid="gray" style={{color : 'gray', width : width-50, marginLeft : 10}} placeholder="Date Start" placeholderTextColor='gray' onChangeText={(email)=>this.setState({email})}/>
                </View>
                <View style={{flexDirection : 'row',width : width, paddingLeft : 10, marginTop : 0}}>
                    <Icon name="ios-calendar" style={{color : "gray", fontSize : 25, marginTop : 10}}/>
                    <TextInput underlineColorAndroid="gray" style={{color : 'gray', width : width-50, marginLeft : 10}} placeholder="Date End" placeholderTextColor='gray' onChangeText={(email)=>this.setState({email})}/>
                </View>
                <View style={{flexDirection : 'row',width : width, paddingLeft : 10, marginTop : 10}}>
                    ...
                    <TextInput underlineColorAndroid="gray" style={{color : 'gray', width : width-50, marginLeft : 10}} placeholder="Event Title" placeholderTextColor='gray' onChangeText={(email)=>this.setState({email})}/>
                </View>
                <View style={{flexDirection : 'row',width : width, paddingLeft : 10,}}>
                    <Icon name="ios-book" style={{color : "gray", fontSize : 25, marginTop : 10}}/>
                    <TextInput multiline={true} underlineColorAndroid="transparent" style={{borderWidth : 1,borderColor : 'gray', borderRadius : 10,color : 'gray', width : width-50, marginLeft : 18}} placeholder="Event Description..." placeholderTextColor='gray' onChangeText={(email)=>this.setState({email})}/>
                </View>
